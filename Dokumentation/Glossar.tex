...
\newglossaryentry{BATCH}{
	name={Batch}, 
	description={
		Quelle:\newline \href{https://docs.datastax.com/en/cql/cassandra/docs/developing/batch/batch.html}{https://docs.datastax.com/en/cql/cassandra/docs/developing/batch/batch.html}\newline
		Ein Batch ist in der Welt von Cassandra eine Sammlung von Statements, die mit Transaktionen von Relationalen Datenbanken vergleichbar sind. Es werden entweder alle in dem Batch enthaltenen Statements ausgeführt oder keine}
}
